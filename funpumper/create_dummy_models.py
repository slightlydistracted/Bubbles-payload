...
# 1) Phase1_survive: expects 12 features (vol/buy/slippage for 0–15,15–60,60–150,150–300)
X1 = np.zeros((2, 12))
y1 = np.array([0, 1])
...
# 3) Phase2_4x: expects 6 features (dex_listed_before_900s, vol_300_600, vol_600_900, sell_cluster_300_900, social_300_600, social_600_900)
X3 = np.zeros((2, 6))
y3 = np.array([0, 1])
...
# 4) Phase3_6x: expects 8 features (six price_ratio bins + whale_rebuy + liquidity_added)
X4 = np.zeros((2, 8))
y4 = np.array([0, 1])
