    ...
    while True:
        try:
            ...
            if FILTERED_PATH.exists():
                ...
                filtered_addresses = {item["address"] for item in filtered_list}
            else:
                filtered_list = []
            ...
            for mint_addr, msg in live_ws.items():
                ...
                if liquidity < MIN_LIQUIDITY or initial_buy < MIN_INITIAL_BUY:
                    ...
                    print(f"[PURGER] Rejecting {mint_addr} (liquidity={liquidity}, initial_buy={initial_buy})")
                else:
                    ...
                    print(f"[PURGER] Accepting {mint_addr} (liquidity={liquidity}, price={price:.6f})")
